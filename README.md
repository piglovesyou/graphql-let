...
-   [Get started webpack loader](#get-started-webpack-loader)
...
| ------------------------------------------------------------------------------ | -------------- | ------------ |
| stability/speed                                                                | ✅             |              |
| Importing GraphQL document file as<br>`import './a.graphql'`                   | ✅             |              |
| Inline GraphQL as <br>`import gql from 'graphql-let'`<br>`` gql(`query {}`) `` |                | ✅           |
